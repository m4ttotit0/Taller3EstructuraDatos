...
// Variable externa definida en system.cpp, usada aquí para conteo
...
{
    int i = 0;
    while (i < hoja->cuenta && clave > hoja->claves[i])
        ++i;
                                        ...
                                        int &outClavePromovida)
{
    ...
    int i = 0;
    while (i < interno->cuenta && clave_hijo_prom > interno->claves[i])
        ++i;
